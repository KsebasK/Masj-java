...
<html lang="es">
  ...
  <body>
    ...
    <div class="contenedor">
      ...
      <p
        class="error"
        style="color: red; justify-content: center; text-align: center"
      >
      ...
      <form action="SvUsuario" method="POST" id="registroForm">
        ...
        <input
          ...
          maxlength="10"
          pattern="[0-9]+"
          title="Solo se permiten números. Entre 6 y 10 dígitos."
        />
        ...
        <input
          ...
          maxlength="10"
          pattern="3[0-9]{9}"
          title="El número debe tener 10 dígitos y comenzar con 3."
        />
        ...
        <input
          type="text"
          name="torre"
          placeholder="Torre (ej: T1)"
          maxlength="10"
          pattern="^T\d+$"
          title="Formato válido: T seguido de números (ej: T1)"
          required
        />
        ...
        <input
          type="text"
          name="apartamento"
          placeholder="Apartamento (ej: APT204)"
          maxlength="15"
          pattern="^AP\d+[A-Z]?$"
          title="Formato válido: AP seguido de números, con letra opcional (ej: APT204A)"
          required
        />
        ...
        <ul class="password-requirements">
          <li id="length" class="invalid">
            <img
              src="imagenes/error_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg"
              alt="Alerta"
              class="alert"
