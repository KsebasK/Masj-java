    ...
    <h1>Bienvenido, Administrador <%= nombreCompleto %> </h1>
        ...
        <div class="cards-grid">
            <div class="card">
                ...
                <p><%= request.getAttribute("totalUsuarios") %></p>
            </div>
            <div class="card">
                <h3>Apartamentos</h3>
                <p><%= request.getAttribute("totalApartamentos") %></p>
            </div>
            <div class="card">
                <h3>Vehículos</h3>
                <p><%= request.getAttribute("totalVehiculos") %></p>
            </div>
            <div class="card">
                <h3>Visitantes Hoy</h3>
                <p><%= request.getAttribute("visitantesHoy") %></p>
            </div>
        </div>
            ...
            <table>
                ...
                %>
                    <tr>
                        ...
                        <td><%= new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm").format(act.getFecha()) %></td>
                        <td>
